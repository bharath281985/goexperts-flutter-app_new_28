...
class ApiEndpoints {
  ...
  static const publicHiringBudgetRanges = '/public/hiring-budget-ranges';
    static const publicProjectBudgetRanges = '/public/project-budget-ranges';
  ...
  static const publicProposals = '/public/proposals';
  ...
  static const publicSearch = '/public/search';
    ...
    static String publicMeetingJoin(String id) => '/public/meetings/$id/join';
    ...
    static const splashSettings = '/public/settings/splash';
    ...
    static String investorMessageConversation(String id) =>
        '/investor/messages/conversations/$id';
    static String investorMessageRead(String id) => '/investor/messages/$id/read';
    ...
    static String founderMessageConversation(String id) =>
        '/founder/messages/conversations/$id';
    static String founderMessageRead(String id) => '/founder/messages/$id/read';
    ...
    static String roleInvestorRequestAccept(dynamic role, String id) =>
        '/${rolePath(role)}/investor-requests/$id/accept';
    static String roleInvestorRequestReject(dynamic role, String id) =>
        '/${rolePath(role)}/investor-requests/$id/reject';
