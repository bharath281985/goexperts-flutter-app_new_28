          ...
          : RefreshIndicator(
              ...
              child: _Content(
                ...
                onShare: () {
                  ...
                  ShareSheet.show(
                    context,
                    title: 'GoExperts invitation',
                    link: link,
                    subtitle:
                        'Join me on GoExperts and grow with a trusted community.',
                  );
                },
              ),
            ),
...
class _Content extends StatelessWidget {
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      _Stat(
                        'Total rewards',
                        _formatReward(stats.totalReward),
                        Icons.stars_rounded,
  ...
  static String _formatReward(num value) =>
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(
              'Share your pass with people who belong here.',
...
class _ShareCard extends StatelessWidget {
  const _ShareCard({required this.details, required this.onCopy});
  final ReferralDetails details;
  final void Function(String, String) onCopy;
  @override
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: details.qrCode.isEmpty
                ? const _QrFallback()
                : Image.network(
                    details.qrCode,
                    fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => const _QrFallback(),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Scan this QR code or copy your personal invitation link.',
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: details.referralLink.isEmpty
                            ? null
                            : () =>
                                  onCopy(details.referralLink, 'Referral link'),
...
class _QrFallback extends StatelessWidget {
  ...
  Widget build(BuildContext context) => const Center(
    child: Icon(Icons.qr_code_2_rounded, size: 72, color: AppColors.mutedText),
  );
}
...
class _HowItWorks extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const steps = [
      ('1', 'Share invite', Icons.send_rounded),
      ('2', 'Friend joins', Icons.person_add_alt_1_rounded),
      ('3', 'Earn reward', Icons.workspace_premium_rounded),
    ];
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(18),
      ...
      if (items.isEmpty)
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 5),
                  Text(
                    'Share your referral link. New referrals and rewards will appear here.',
                    textAlign: TextAlign.center,
                    style: context.text.bodySmall,
                  ),
                ],
        ...
        ...items.map((item) {
          final title =
              ...
              item['referralCode'] ??
              'Referral';
          final status = item['status'] ?? 'Invited';
          final subtitle = item['createdAt'] ?? item['date'] ?? item['reward'];
          return Card(
            child: ListTile(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('Couldn’t load referrals', style: context.text.titleLarge),
          const SizedBox(height: 8),
