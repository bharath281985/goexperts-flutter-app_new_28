  ...
  Widget build(BuildContext context) {
    return DetailView<Technology>(
      ...
      actions: detailActions(
        context,
        shareTitle: 'this technology',
        shareLink: '${Routes.technologyDetails}/$id',
        reportType: 'technology',
      ),
      bottomBar: (context, t) => Padding(
        padding: const EdgeInsets.all(AppSizes.lg),
        child: AppPrimaryButton(
          label: 'Find ${t.name} Experts',
          icon: Icons.search_rounded,
          onPressed: () => context.showSnack('Browsing ${t.name} talent'),
        ),
      ),
      builder: (context, t) => ListView(
        ...
        children: [
          ...
          DetailSection(
            title: 'Overview',
            child: Text(t.description, style: context.text.bodyMedium),
          ),
          AppSizes.vGapLg,
          DetailSection(
            title: 'Adoption',
            child: AppCard(
              child: Column(
                ...
                children: [
                  Text(
                    '${t.popularity}% market popularity',
          ...
          if (t.relatedSkills.isNotEmpty) ...[
            ...
            DetailSection(
              ...
              child: DetailChips(items: t.relatedSkills),
            ),
          ],
                    ...
                    AppCard(
                      ...
                      child: Row(
                        children: [
                          ...
                          AppSizes.hGapMd,
                          Expanded(
                            child: Text(r, style: context.text.bodyMedium),
                          ),
                          const Icon(
